...
def standard(fe):
    fes=[]
    media = med(fe)
    desvio_padrao = sdev(fe)
    for x in fe:
        x_standard = (x - media)/desvio_padrao
        fes.append(x_standard)
    return fes
...
#coloque o seu código aqui
    gradient_th0 = gradt0(x, y, th)
    gradient_th1 = gradt1(x, y, th)
    th[0] =  th[0] - alfa*gradient_th0
    th[1] = th[1] - alfa*gradient_th1
    return (th)
...
#  O primeiro elemento de laux é 0.6641327329009109   
